-- Populate database for acceptance (migrated from legacy populateDB.sql)
-- Using explicit column lists to ensure proper column order

-- Specialties first (referenced by vets)
